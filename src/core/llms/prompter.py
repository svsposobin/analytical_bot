...
class LLMPrompter:
    CONTEXT_DESCRIPTIONS: Dict[str, Dict] = {
        ...
        "CountVideosPerCreatorAboveViews": {
            "description":
                "Запрос количества видео у конкретного креатора, которые набрали больше заданного количества просмотров",
            "examples": [
                """
                Сколько видео у креатора с id aca1061a9d324ecf8c3fa2bb32d7be63 набрали больше 10 000 просмотров по 
                итоговой статистике?
                """,
                "Количество видео креатора 123 с просмотрами выше 50000",
                "Сколько видео у автора 456 имеет более 1000 просмотров?"
            ],
            "response_format": {
                "key_context": "CountVideosPerCreatorAboveViews",
                "context": {
                    "creator_id": "строка с ID креатора",
                    "views": "целое число (int)"
                }
